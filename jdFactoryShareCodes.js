...
const su8600 = 'T018v_VxQhgf91PVJxyb1ACjVWnYaS5kRrbA',
  ja4412 = 'T0225KkcRk9NpgLWchrxx_4LcACjVWnYaS5kRrbA',
  su4894 = 'T0205KkcPXhRpDWRaEig1Y1iCjVWnYaS5kRrbA',
  chun0799 = 'T0205KkcNEdqoBSid3uq5q9SCjVWnYaS5kRrbA'

let shareCodes = [
  `${ja4412}@${su4894}@${chun0799}`,
  `${su8600}@${su4894}@${chun0799}`,
  `${su8600}@${ja4412}@${chun0799}`,
  '',
  `${su8600}@${ja4412}@${su4894}`,
]
